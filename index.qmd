...
* Wycenę nieruchomości dla celów:
    * Kredytów hipotecznych <i class="fa fa-home"></i>
    * Spadków <i class="fa fa-last-will"></i>
    * Podziału majątku <i class="fa fa-balance-scale"></i>
    * Transakcji kupna-sprzedaży <i class="fa fa-handshake"></i>
    * Zabezpieczenia wierzytelności <i class="fa fa-lock"></i>
    * Odszkodowania za inwestycje liniowe <i class="fa fa-money-bill-alt "></i>
* Operaty szacunkowe <i class="fa fa-calculator"></i>
* Opinie i ekspertyzy <i class="fa fa-lightbulb"></i>
